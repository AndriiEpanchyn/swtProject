...
// Create_main_window
	...
	public void run() {
		GridLayout grid1 = new GridLayout(1, true);
...
//Combo
		...
		combo = new Combo(firstTabGroups[1], SWT.CENTER | SWT.READ_ONLY);
...
//SingEquals	
		...
		equal = new Text(firstTabGroups[1], SWT.NONE);
		equal.setText("=");
		equal.pack(true);
...
//Answer	
		...
		answer = new Text(firstTabGroups[1], SWT.RIGHT | SWT.READ_ONLY | SWT.BORDER);
		answer.setText("0.00");
